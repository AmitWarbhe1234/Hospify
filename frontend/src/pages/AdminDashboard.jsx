...
function AdminDashboard() {
  ...
  useEffect(() => {
    const checkAdmin = async () => {
      try {
        ...
        console.log("Admin Authentication Error:", error.response?.data);
  ...
  useEffect(() => {
    const fetchStaff = async () => {
      try {
        ...
        console.log("Staff List Error:", error.response?.data);
      }
    };
  ...
  useEffect(() => {
    const fetchPatients = async () => {
      try {
        ...
        console.log("Patient List Error:", error.response?.data);
      }
    };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await API.post("/auth/staff/create/", {
        email: email,
        password: password,
      ...
      console.log("Staff Creation Error:", error.response?.data);

      setError(error.response?.data?.detail || "Failed to create staff.");
    }
  };
      ...
      <main className="admin-container">
        ...
        <div className="admin-header">
          <div>
            ...
            <p>
              Manage your healthcare staff and system operations from one
              place.
            </p>
          </div>
        ...
        <div className="analytics-section">
          ...
          {/* SUMMARY CARDS — Total Appointments + Completed Appointments */}
          ...
          {/* APPOINTMENT STATUS CHART — ab alag, apni khud ki jagah pe */}
            ...
            <ResponsiveContainer width="100%" height={300}>
              <PieChart>
                <Pie
                  ...
                  label
                >
                  {Object.entries(analytics?.appointment_status || {}).map(
                    ([name], index) => (
                      <Cell
                        key={`cell-${index}`}
            ...
            <ResponsiveContainer width="100%" height={300}>
              <PieChart>
                <Pie
                  ...
                  label
                >
                  {Object.entries(analytics?.gender_distribution || {}).map(
                    ([name], index) => (
                      <Cell
          ...
          <div className="analytics-chart-card">
            ...
            <ResponsiveContainer width="100%" height={300}>
              <LineChart
                data={Object.entries(analytics?.monthly_appointments || {})
        ...
        <section className="admin-card">
          <div className="admin-card-header">
            ...
            <div>
              ...
              <p>
                Add a doctor, receptionist or lab technician to your
                healthcare team.
              </p>
            </div>
          </div>
        ...
        <section className="admin-card staff-card">
          <div className="admin-card-header">
            <div className="admin-section-icon staff">👥</div>
          ...
          <div className="admin-modal-overlay" onClick={cancelDelete}>
            ...
            >
              ...
              <div className="admin-modal-actions">
                <button onClick={cancelDelete} className="admin-modal-cancel">
                  Cancel
                </button>
